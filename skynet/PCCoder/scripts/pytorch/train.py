...
from skynet.DeepCoder.env.operator import Operator, operator_to_index
from skynet.DeepCoder.env.statement import Statement, statement_to_index
from skynet.PCCoder.model_pytorch.model import PCCoder
from skynet.PCCoder.params import pcCoder_params as params
from skynet.cuda import use_cuda, LongTensor, FloatTensor
...
def train(args):
    ...
    model = PCCoder('PCCoder_pytorch')
    model.load('D:\KPI\diplom\skynet\PCCoder\\result\model_weights\model_pytorch')
    ...
    data, statement_target, drop_target, operator_target = torch.LongTensor(data), torch.LongTensor(statement_target), \
                                                           torch.FloatTensor(drop_target), torch.LongTensor(
        operator_target)
