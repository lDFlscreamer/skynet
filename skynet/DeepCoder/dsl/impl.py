...
from skynet.DeepCoder.dsl.DeepCoder_types import INT, LIST, BOOL
from skynet.DeepCoder.dsl.deepCoder_function_pool import DeepCoder_Function_pool
...
ZIPWITH = Function('ZIPWITH', lambda f, xs, ys: [f(x, y) for x, y in zip(xs, ys)],
                   (FunctionType((INT, INT), INT), LIST, LIST), LIST)
...
function_pool = DeepCoder_Function_pool(LAMBDAS, HIGHER_ORDER_FUNCTIONS, FIRST_ORDER_FUNCTIONS)
