...
from skynet.dsl.function import Function_base as Function, OutputOutOfRangeError, NullInputError
from skynet.env.statement import Statement


class ProgramState_base(object):
    """
...
class ProgramEnv(object):
    ...
    def __init__(self, examples=[], programState_class = ProgramState_base):
        self.states = [programState_class(example) for example in examples]
        self.var_types = []
        if examples:
